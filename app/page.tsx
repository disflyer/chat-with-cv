...
export default function Home() {
  ...
  return (
    <div
      className={`flex h-screen flex-col items-center p-24 ${silkscreen.className}`}
    >
      ...
      <div
        ref={warpperRef}
        className="flex-1 border-black border-2 m-10 w-6/12 h-3/6 overflow-y-scroll noscrollbar"
      ...
      <div className="border border-black w-6/12 flex">
        <textarea
          ...
          spellCheck={false}
          className="min-h-[60px] noscrollbar w-full resize-none bg-transparent px-4 py-[1.3rem] focus-within:outline-none sm:text-sm"
        />
